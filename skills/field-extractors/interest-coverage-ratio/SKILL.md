...
description: "Extract interest coverage ratio current value, minimum threshold, and compliance status from covenant disclosures."
---

# interest-coverage-ratio

Use this skill when extracting the `interest-coverage-ratio` field.
