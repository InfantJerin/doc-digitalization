...
description: "Extract overall compliance disposition (COMPLIANT/BREACH/WAIVER/PENDING) with explicit supporting text."
---

# compliance-status

Use this skill when extracting the `compliance-status` field.
