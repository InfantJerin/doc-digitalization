...
description: "Extract covenant list entries including metric, threshold, and testing frequency from covenant sections."
---

# financial-covenants

Use this skill when extracting the `financial-covenants` field.
